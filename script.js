const CONFIG = {
    mainQuestion: "Hai lomi,Will you be my Valentine?",
    subQuestion: "Womakk sodap nii",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["Eits, ga bisa😝", "Hehe, coba lagi 😜", "Yaudah deh, aku anggap YES ya! 💕"],
    confirmTitle: "YEYYY! Kamu Beneran Mau 💗",
    ...
    bouquetMessage: "Yeay! Udah jadi milik kamu 💕. Bentuk fisiknyaa ditunggu yahh hehehe",
    nextFlowerButton: "Next ",
    collageTitle: "My Sweet Angel gwehh…",
    collageSubtitle: "Sejak kamu hadir, hal sekecil apapun terasa istimewa. Happy Valentine, my everything. 💕",
    nextCollageButton: "Satu halaman lagi… ",
    finalTitle: "Happy Valentine, My Love 💞",
    finalMessage: `Makasih yaaa cintaa sudah hadir dan bikin hariku selalu terasa cukup. Kamu adalah alasan kenapa senyum ini tidak pernah hilang. Semoga hari hari kita (eh kamu maksudnya hehe) selalu penuh kebahagiaan dan kehangatan. I'll always be here for you. Happy Valentine cintaa! 💕`,
